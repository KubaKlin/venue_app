...
const venueTypes = [
  "cozy cabin", "mountain lodge", "lakeside cottage", "forest retreat", "countryside villa",
  "enchanted hut", "rustic barn", "treehouse", "glamping tent", "tiny house",
  "stone cottage", "wooden chalet", "eco lodge", "boutique hideaway", "vintage cabin",
  "modern retreat", "traditional manor", "minimalist lodge", "artistic studio", "wellness center"
];

const features = [
  "kitchen facilities", "bathroom facilities", "fireplace", "hypoallergic bedding",
  "speakers", "TV", "WiFi", "pet friendly", "parking", "lake and mountains nearby",
  "air conditioning", "heating", "washing machine", "dishwasher", "microwave",
  "coffee machine", "balcony", "terrace", "garden", "barbecue", "hot tub",
  "sauna", "gym", "pool", "bike rental", "kayak rental", "hiking trails",
  "ski storage", "game room", "library", "workspace", "printer", "safe"
];
...
const generateVenueDetails = (venue, detailsId) => {
  const selectedFeatures = faker.helpers.arrayElements(features, { min: 5, max: 15 });
...
const generateData = () => {
  ...
  console.log(`Successfully generated ${VENUE_COUNT} venues and ${VENUE_COUNT} venue details!`);
};
