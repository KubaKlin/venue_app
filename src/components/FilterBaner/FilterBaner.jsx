    ...
    >
      <Container maxWidth="lg">
        ...
        <Box sx={{ display: 'flex', gap: '2rem', my: 2 }}>
          <FilterTextField label="Location" startIcon={<SearchIcon />} />
          <FilterTextField label="Occasions" startIcon={<SearchIcon />} />
          <FilterTextField label="Date" startIcon={<CalendarTodayIcon />} />
          <FilterTextField
            label="Guests"
            startIcon={<RemoveIcon />}
            endIcon={<AddIcon />}
          />
          <FilterTextField label="Venue type" startIcon={<SearchIcon />} />
        </Box>
