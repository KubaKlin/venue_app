...
export const createRoomAmenityHandler =
  (setRoomAmenities) => (amenity) => (event) => {
...
export const createNeighbourhoodHandler =
  (setNeighbourhoods) => (neighbourhood) => (event) => {
...
export const createHandicapAccessibilityHandler =
  (setHandicapAccessibility) => (accessibility) => (event) => {
